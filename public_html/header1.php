<table width="900" border="0" align="left" cellpadding="0" cellspacing="0">
  <tr> 
    <td width="983"><img src="images/index_02.jpg" width="391" height="69"></td>
  </tr>
  <tr> 
...
<table width="741" border="0" align="left" cellpadding="0" cellspacing="0">
            <tr class="menu"> 
              ...
              <td width="126"><a href="index.php" class="menu">Home</a></td>
              <td width="181"><a href="cart.php" class="menu">Shopping Cart</a></td>
              <td width="132"><a href="howtobuy.php" class="menu">How to buy</a></td>
              <?PHP
