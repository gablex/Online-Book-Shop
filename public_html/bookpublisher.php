...
$sql="SELECT BK_ID,authermaster.AUTH_NAME,BK_TITLE,BK_CURRENCY,BK_SHOPPRICE,BK_IMAGE,BK_EDITION,PUB_NAME  FROM bookmaster,authermaster,publishermaster WHERE bookmaster.BK_PUBLISHER = publishermaster.PUB_ID AND bookmaster.BK_AUTH = authermaster.AUTH_ID AND publishermaster.PUB_ID =".$_SESSION['pub']; //select record from tha table
