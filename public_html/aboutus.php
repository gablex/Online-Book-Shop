...
$sql="SELECT misc_content   FROM miscsections WHERE misc_id =1"; //select record from tha table
          ...
          <td width="600" align="left" valign="top" class="menu"><table width="600" border="0" cellpadding="0" cellspacing="0">
              ...
              <tr>
                <td align="left" valign="top"><table width="600" border="0" cellpadding="0" cellspacing="0">
                  <tr> 
                    <td width="600" height="401" align="left" valign="top"><table width="600" border="0" cellpadding="0" cellspacing="0">
                        <tr> 
                          <td height="67">&nbsp;</td>
                          <td colspan="2" valign="top" class="bigtitle"><table width="209" height="52" border="0" cellspacing="2">
                              <tr> 
                                <td valign="bottom" background="images/register.jpg"><table width="209" border="0" cellpadding="0" cellspacing="0">
                                    <tr> 
                                      <td width="64">&nbsp;</td>
                                      <td width="145" class="wtlogin">About Us</td>
                                    </tr>
                                  </table></td>
                              </tr>
                            </table></td>
                        ...
                        <tr> 
                          <td height="44">&nbsp;</td>
                          <td width="7" rowspan="2" align="left" valign="top" class="normaltxt">&nbsp;</td>
                          <td width="584" rowspan="2" align="left" valign="top" class="normaltxt"><?PHP echo nl2br($details); ?></td>
                        </tr>
                        <tr> 
