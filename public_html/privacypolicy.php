...
$sql="SELECT misc_content   FROM miscsections WHERE misc_id =2"; //select record from tha table
                    ...
                    <td width="600" height="397" align="left" valign="top"><table width="600" border="0" cellpadding="0" cellspacing="0">
                        <tr> 
                          ...
                          <td colspan="2" valign="top" class="bigtitle"><table width="209" height="52" border="0" cellspacing="2">
                              <tr> 
                                <td valign="bottom" background="images/registerband.jpg"><table width="209" border="0" cellpadding="0" cellspacing="0">
                                    <tr> 
                                      <td width="64">&nbsp;</td>
                                      <td width="145" class="wtlogin">Privacy 
                                        Policy </td>
                                    </tr>
                                  </table></td>
                              </tr>
