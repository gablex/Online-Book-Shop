                    ...
                    <td width="570"><table width="570" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr> 
                          ...
                          <td width="566"><table width="555" border="0" cellpadding="0" cellspacing="0">
                              <tr> 
                                <td width="194" align="center" valign="middle"><img src="images/<?PHP echo $objBook->BK_IMAGE;?>" width="100" height="130"></td>
                                <td width="361" align="left" valign="top"><table border="0">
                                    <?PHP 
								   if($objBook->AUTH_NAME  !="0"){ 
								   ?>
                                    <tr> 
                                      <td width="142" height="25" class="ashlabel">Author</td>
                                      <td class="menu">:</td>
                                    ...
                                    <tr> 
                                      ...
                                      <td width="188" class="txtblack"><?PHP echo $objBook->BK_ISBNTWO; ?> 
                                        <span class="menu"> : </span><?PHP echo $objBook->BK_ISBNONE; ?></td>
                                    </tr>
                                    <?PHP
                        ...
                        <tr> 
                          <td >&nbsp;</td>
                          <td height="21" class="normaltxt"><?PHP echo $objBook->BK_AUTHDETAILS; ?></td>
                        </tr>
                        <tr> 
                          <td></td>
                          <td height="1"  bgcolor="#990000" ></td>
