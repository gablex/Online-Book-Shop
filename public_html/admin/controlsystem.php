	...
	case 2:
	  ...
	  switch($category){
	   ...
	   case 4:
		...
		break;
	   case 5:
	    $page="specialoffer.php";
		break;
	   case 6:
	    $page="listbookrelation.php";
		break;
	   case 7:
	    $page="listbookall.php";
		break;
	   default:
	     $page="addbook.php";	 
		 break;
	 ...
	 case 3://category management
	  ...
	  switch($category){
	   ...
	   case 2:
		...
		break;
	  case 3:
	    $page="categorysection.php";	    
		break;
	  case 4:
	    $page="parentcategory.php";	    
		break;
	   default:
	     $page="category.php";
		 break;
	 ...
	 break;	 
	  ...
	  case 10://Misc section
      $menu="menu/login.php";
		switch($category){
		case 1 :
		$page="addcurrencyrate.php";
		 break;
	   default:
	     $page="addcurrencyrate.php";
		 break;
