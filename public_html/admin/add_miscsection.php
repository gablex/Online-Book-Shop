...
$oFCKeditor1->Value=stripslashes($obj->misc_content);
}
?>
<html>
<head>
  ...
  <table width="82%" border="0" align="center" cellpadding="0" cellspacing="1">
	...
	<tr> 
      ...
      <td width="82%"><select name="section" class="txtbox" id="section" onChange="document.frm_exchange.submit();">
          ...
          <option value="3" <?PHP if($edid == 3) echo "selected"; ?>>How To Buy</option>
		   <option value="4" <?PHP if($edid == 4) echo "selected"; ?>>International Shipping</option>
        </select></td>
    </tr>
    <tr> 
	...
	if(isset($_REQUEST['section'])){
	?> 
	<input type="hidden" name="id" value="<?php echo $_REQUEST['section'];?>">
	<?PHP
	}
	?>
    <tr align="center"> 
