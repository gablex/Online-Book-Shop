...
"> </td>
    ...
    <tr> 
      ...
      <td colspan="2" align="left"> <input name="auther" type="text" class="txtbox" id="auther" value="<?PHP echo $auther; ?>"></td>
    </tr>
    <tr> 
      ...
      <td colspan="2" align="left" class="labeltxt"><input name="edition" type="text" class="txtbox" id="edition" value="<?PHP echo $edition; ?>">
        ...
        <select name="binding"  id="binding">
          ...
          <option value="Hardbound" <?PHP if($binding == "Hardbound") echo "selected"; ?>>Hardbound</option>
          <option value="Looseleaf" <?PHP if($binding == "Looseleaf") echo "selected"; ?>>Looseleaf</option>
        </select>
    </tr>
    <tr> 
   ...
   ?>
        ...
        <img src="images/pop.jpg" alt="Add New Publisher" width="25" height="24" onClick="window.open ('http://onlinebookshop.in/admin/publisher_popup.php','publisher','menubar=1,resizable=1,width=650,height=475'); 
"> </td>
    </tr>
    <tr> 
