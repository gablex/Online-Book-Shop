...
mCon.connectionString=Server.MapPath("db/news.mdb")
mCon.open
...
'Load corresponding details in to fckeditor		

IF Trim(qrsNewsID) = "" Then
	sValue			= ""
else	
	dim rpset
	'mCon.open
	
	set rpset=Server.CreateObject("ADODB.Recordset")
	rpset.open "Select * From News Where NewsID=" & qrsNewsID ,mCon,3,3
	sValue	= rpset("InnerPage")
	'session("qrsNewsID")=""
