...
<table width="175" border="0" cellpadding="0" cellspacing="0">
  <tr align="right"> 
    <td height="12" colspan="2"><img src="images/top.jpg" width="175" height="12"></td>
  </tr>
  <?PHP 
					 if($_REQUEST['msg'] == 1 ){
                     ...
                     ?>
  <tr> 
    <td width="174" align="right" valign="top" background="images/index_50.jpg" class="whtcart"> 
      <?PHP 
          ...
          <td width="172" height="42" align="left" valign="top" background="images/index_50.jpg" > 
            <table width="167" height="93" border="0" cellspacing="0">
              <form action="" name="logfrm" method="post" onSubmit="return frmValidate();">
                <tr> 
                  <td height="18" colspan="2" align="center" class="wtlogin">LOGIN</td>
                </tr>
                <tr> 
                ...
                <tr> 
                  ...
                  <td><input name="pwd" type="text" class="logbox" id="pwd"></td>
                </tr>
                <tr align="center"> 
                  <td height="10" colspan="2"><input name="Submit" type="submit" class="subwhite" value="Submit"></td>
                </tr>
              </form>
            </table></td>
        </tr>
      ...
      <table width="171" border="0" cellpadding="0" cellspacing="0">
        <tr> 
          <td width="139"  align="center" class="logtxt">&nbsp;Welcome&nbsp;<?PHP echo $_SESSION['username']; ?></td>
        </tr>
      </table>
      <?PHP }?>
    </td>
  ...
  <tr> 
    <td align="center" valign="top"> <table width="171" border="0" cellpadding="0" cellspacing="0">
        <?PHP
		...
		?>
		 <tr> 
          <td width="170" height="21" align="center" class="redbrowse"></td>
        </tr>
        <tr> 
          <td height="21" align="left" class="redbrowse"><strong><?PHP echo $obj->catsec_name ;?></strong></td>
        </tr>
        <tr> 
          <td class="redbrowse" align="center" valign="top" >.........................................</td>
        </tr>
        <?PHP
		}
		?>
        <tr> 
          <td align="right" valign="top"> <table width="168" border="0" cellpadding="0" cellspacing="0">
              <tr> 
                <td width="162" align="left" class="blackbold"><a href="productcategory.php?catid=<?PHP echo $obj->CAT_ID; ?>" class="leftmenu"><?PHP echo $obj->CAT_NAME ?></a></td>
              </tr>
              <tr> 
                <td height="10" align="left" valign="top" class="normaltxt"></td>
              </tr>
            </table></td>
        </tr>
        <?PHP 
  ...
  <tr>
    <td align="right" valign="top" colspan="2"><img src="images/btmmnu2.jpg" width="175" height="17"></td>
  </tr>
</table>
<map name="Map">
