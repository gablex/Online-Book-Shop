...
<table width="175" border="0" cellpadding="0" cellspacing="0">
  <tr align="right"> 
    <td height="8%" colspan="2"><img src="images/top.jpg" width="175" height="12"></td>
  </tr>
  <?PHP 
					 if($_REQUEST['msg'] == 1 ){
  ...
  <tr> 
    <td rowspan="2" align="center" valign="top"> <table width="164" border="0" cellpadding="0" cellspacing="0">
        <?PHP
		...
		?>
        <tr> 
          <td height="21" align="center" class="redbrowse"></td>
        </tr>
        <tr> 
		...
		?>
        <tr> 
          <td align="center" valign="top"> <table width="154" border="0" cellpadding="0" cellspacing="0">
              <tr> 
                <td width="154" align="left"><a href="productcategory.php?catid=<?PHP echo $obj->CAT_ID; ?>" class="leftmenu"><?PHP echo $obj->CAT_NAME ?></a></td>
              </tr>
              <tr> 
                <td height="10" align="left" valign="top" class="normaltxt" background=""></td>
              </tr>
            </table></td>
        </tr>
        <?PHP 
  ...
  <tr> 
    <td width="1" height="20%" background="images/index_50.jpg" class="whtcart">&nbsp;</td>
  </tr>
  <tr> 
    <td height="20%" align="center" valign="top" colspan="2"><img src="images/btmmnu2.jpg" width="175" height="17"></td>
  </tr>
</table>
<map name="Map">
