...
<table width="600" height="393" border="0" cellpadding="0" cellspacing="0">
                              ...
                              <tr> 
                                <td height="105" align="center" valign="top" width="600"> 
                                    ...
                                    <tr> 
                                      <td width="595" align="center" valign="top"> 
                                        ...
                                        <table width="179" height="195" border="0" cellpadding="0" cellspacing="0">
                                          <tr> 
                                            <?PHP
								 $sql="SELECT BK_ID,BK_AUTH,BK_TITLE,BK_CURRENCY,BK_SHOPPRICE,BK_IMAGE  FROM bookmaster WHERE BK_FEATURED=1 AND BK_CAT IN (SELECT CAT_ID FROM categorymaster WHERE CAT_PARENT =".$_REQUEST['catid'].") order by BK_CDATE DESC LIMIT 9"; //select record from tha table
   								 $res = $cmdClass->ExecuteQuery($sql);
								 $cnt = 0;
								 while($obj = $cmdClass->getObject($res)){
								 ...
								 ?>
                                            <td width="175"><table width="181" border="0" align="center" cellpadding="0" cellspacing="0">
                                                <tr align="center" valign="top"> 
                                                  <td height="149" colspan="2"><a href="bookdetails.php?prdid=<?PHP echo $obj->BK_ID; ?>"><img src="images/<?PHP echo $obj->BK_IMAGE; ?>" alt="View Details" width="100" height="130" border="0"></a></td>
                                                </tr>
                                                <tr align="center" class="itemtitle"> 
                                                  <td colspan="2"><a href="bookdetails.php?prdid=<?PHP echo $obj->BK_ID; ?>" class="itemtitle"><?PHP echo $obj->BK_TITLE; ?></a></td>
                                                </tr>
                                                <tr align="center" class="itemtitle"> 
                                                  <td colspan="2"><span class="prred">By 
                                                    : </span> &nbsp;<?PHP echo $obj->BK_AUTH ; ?></td>
                                                </tr>
                                                <tr class="prred"> 
                                                  <td width="129">&nbsp;&nbsp;Price 
                                                    : <?PHP echo $obj->BK_CURRENCY ." ".$obj->BK_SHOPPRICE; ?></td>
                                                  <td width="52" align="left"><a href="add_to_cart.php?prdid=<?PHP echo $obj->BK_ID ; ?>"><img src="images/cart.jpg" alt="Add to Cart" width="25" height="20" border="0"></a></td>
                                                </tr>
                                                <tr class="prred"> 
                                                  <td>&nbsp;</td>
                                                  <td align="left">&nbsp;</td>
